...
const ACCOUNTS = (process.env.ETH_KEYS ? process.env.ETH_KEYS.split(',') : 
  ["truth latin vacuum region sing sausage bachelor account fitness mango inch word"])
  .map(key => key.trim())
...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      ...
      accounts: { mnemonic: "truth latin vacuum region sing sausage bachelor account fitness mango inch word"},
    },
